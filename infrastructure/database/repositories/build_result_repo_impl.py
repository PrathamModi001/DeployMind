...
from domain.repositories.build_result_repository import BuildResultRepository
from infrastructure.database.models import BuildResult as BuildResultModel
