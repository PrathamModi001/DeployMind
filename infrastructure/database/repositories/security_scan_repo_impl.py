...
from domain.repositories.security_scan_repository import SecurityScanRepository
from infrastructure.database.models import SecurityScan as SecurityScanModel
